...
sudo snap install btop #installs btop monitoring tool
sudo apt-get install git #duh git
sudo apt-get install unzip #unzip which is needed for tfc agent install.
